...
# set window title
pygame.display.set_caption("Gates' car game")
# set background colour
screen.fill((0, 110, 150))
# apply changes
...
#resize image
car = pygame.transform.scale(car, (140, 230))
car_loc = car.get_rect()
car_loc.center = right_lane, height*0.8

# load enemy vehicle
car2 = pygame.image.load("otherCar2.png")
car2 = pygame.transform.scale(car2, (140, 230))
